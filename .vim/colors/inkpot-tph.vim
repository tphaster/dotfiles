...
" Modified:   Tomasz Pieczerak <tphaster AT gmail.com>
"
...
if has("gui_running")
    ...
    exec "hi StatusLine     cterm=BOLD   ctermfg=" . <SID>X(86) . " ctermbg=" . <SID>X(81)
    ...
    exec "hi MBENormal                  cterm=NONE  ctermfg=" . <SID>X(86) . " ctermbg=" . "NONE"
    exec "hi MBEChanged                 cterm=NONE  ctermfg=" . <SID>X(1)  . " ctermbg=" . "NONE"
    exec "hi MBEVisibleNormal           cterm=NONE  ctermfg=" . <SID>X(73) . " ctermbg=" . <SID>X(81)
    exec "hi MBEVisibleChanged          cterm=NONE  ctermfg=" . <SID>X(73) . " ctermbg=" . <SID>X(81)
    ...
    exec "hi Error          cterm=NONE   ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(1)
    exec "hi Identifier     cterm=NONE   ctermfg=" . <SID>X(54) . " ctermbg=" . "NONE"
    exec "hi Ignore         cterm=NONE"
    exec "hi Number         cterm=NONE   ctermfg=" . <SID>X(69) . " ctermbg=" . "NONE"
    exec "hi PreProc        cterm=NONE   ctermfg=" . <SID>X(25) . " ctermbg=" . "NONE"
    exec "hi Special        cterm=NONE   ctermfg=" . <SID>X(71) . " ctermbg=" . "NONE"
    exec "hi SpecialChar    cterm=NONE   ctermfg=" . <SID>X(71) . " ctermbg=" . <SID>X(81)
    exec "hi Statement      cterm=NONE   ctermfg=" . <SID>X(27) . " ctermbg=" . "NONE"
    exec "hi Todo           cterm=BOLD   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(77)
    exec "hi Type           cterm=NONE   ctermfg=" . <SID>X(56) . " ctermbg=" . "NONE"
    ...
    if v:version >= 700
        ...
        exec "hi SpellBad       cterm=UNDERLINE   ctermfg=" . <SID>X(64) . " ctermbg=" . "NONE"
    ...
    if v:version >= 703
        ...
        exec "hi ColorColumn  cterm=NONE      ctermbg=" . <SID>X(16)
    endif
endif
